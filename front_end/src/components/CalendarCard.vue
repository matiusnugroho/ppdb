	...
	<div class="w-full max-w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
		...
		<div class="grid grid-cols-7">
			<div
				...
				<div class="mx-auto flex h-24 w-10 flex-col overflow-hidden sm:w-full md:h-40 md:w-20 lg:w-28 2xl:w-40">
					...
					<div v-if="isDateSelected(day)" class="group h-16 w-full flex-grow cursor-pointer py-1 md:h-30">
						...
						<div
							...
							<span class="event-name text-sm font-semibold text-black dark:text-white"> Redesign Website </span>
							<span class="time text-sm font-medium text-black dark:text-white"> 1 Dec - 2 Dec </span>
						</div>
					</div>
				</div>
			</div>
