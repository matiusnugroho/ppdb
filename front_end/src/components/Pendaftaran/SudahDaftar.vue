<template>
	<div class="text-center mb-5">
		<h1 class="text-3xl font-bold text-black dark:text-white">Harusnya di sini form upload dokumen</h1>
		<div v-if="loadingDocumentType">Loading</div>
			...
			<table class="w-full table-auto">
				...
				<tbody>
					<tr v-for="(item, index) in documentTypeList" :key="index">
						...
						<td>
							<p class="inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium bg-warning text-warning">Belum Upload</p>
						</td>
						<td class="py-5 px-4">
